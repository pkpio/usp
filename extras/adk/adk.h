...
#define ADK_MAN "USCTP-DEV"					/* Board manufacturer */
#define ADK_MOD "USCTP Android"					/* Board model */
#define ADK_DES "USCTP Android Demo"				/* Board description */
#define ADK_VER "1.0"						/* Board version */
#define ADK_URI "https://github.com/praveendath92/usctp"	/* Board url */
#define ADK_SER "123"						/* Board serial */
